...
async def apply_flow(
    ...
    processed_application_data = processed_application_type(
        **raw_app_data_dump,
...
async def apply(
    ...
    return await apply_flow(
        user, raw_application_data, processed_application_type=ProcessedApplicationData
    )
