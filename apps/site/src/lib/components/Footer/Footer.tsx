...
const Footer = () => {
  return (
    <footer className={styles.footer}>
		<div className="flex w-full justify-end max-[600px]:justify-center">
      	...
      	<div className="mt-2 flex w-full items-center justify-between gap-[18px] max-[600px]:flex-col max-[600px]:items-center max-[600px]:justify-center">
			<a
			...
			>
				<Image src={hack} alt="Hack logo that links to Hack at UCI's website" width={42} height={42} />
			</a>
