			...
			<div className="w-full relative flex max-lg:flex-col-reverse max-lg:gap-20">
				...
				{selectedEvent ? (
					<div className="w-[50%] relative flex max-lg:hidden lg:min-h-[700px]">
						<EventCard
							key={`${selectedEvent.title}-${selectedEvent.startTime.toISOString()}`}
							now={now}
							isHappening={false}
							{...selectedEvent}
						/>
					...
					<div className="w-[50%] min-h-[700px] relative flex max-lg:hidden justify-center items-center">
						<div className="text-4xl text-center font-display">
							No Event Selected...
						</div>
					</div>
				)}
