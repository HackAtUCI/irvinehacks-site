	...
	return (
		<>
			<section className="container md mx-auto text-center my-14 max-w-sm sm:max-w-lg xl:max-w-screen-md relative">
				<Lantern width={300} height={300} className="lg:hidden mx-auto" />
				<Lantern
					width={300}
					height={300}
				...
				<div className="text-2xl lg:text-3xl mb-5">
					...
					<h2>
						<span className={styles.statistic}>$5,000+</span> in Prizes
					</h2>
				</div>
				<h3 className="text-xl lg:text-2xl mb-5">Create + Connect + Inspire</h3>
				<p>
					IrvineHacks is the largest collegiate hackathon in Orange County and
				...
				<p>
					This year, IrvineHacks will take place the weekend of January 26th to
					28th. The event will be 100% in-person during the day (not overnight).
