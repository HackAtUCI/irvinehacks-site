...
const Footer = () => {
	...
	<footer className={`${styles.footer} flex flex-col items-center`}>
		...
		<div className=" flex flex-row gap-1 items-center mt-2">
			...
			<h2>in Irvine, CA • Learn more about the <a href="https://hack.ics.uci.edu" target="_blank" rel="noopener noreferrer"><span style={{"color" : "#FBA80A"}}>Hack @ UCI Team</span></a></h2>
		</div>
