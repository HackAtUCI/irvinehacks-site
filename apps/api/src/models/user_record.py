...
from models.ApplicationData import Decision, ProcessedApplicationData, ProcessedMentorApplicationData
...
class Applicant(BareApplicant):
    ...
    application_data: Union[ProcessedApplicationData, ProcessedMentorApplicationData]
