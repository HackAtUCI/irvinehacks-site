				...
				({ _id, iconUrl, title, description, resources }) => (
					<>
						...
						<div className="flex flex-row items-center justify-center">
							<Image src={extraBorder} alt="extra border" height={500} className={styles.leftBorder}/>
							<div className="bg-gradient-to-b from-[#00FFFF80] via-[#170F5180] to-[#00FFFF80] w-full max-w-[400px] md:max-w-5xl p-5 sm:p-7 grow-[2] mb-12 rounded-md select-none">
									...
									<div className="pb-[9px]">
										...
										<div className="hidden md:flex flex-row items-center justify-center">
											<Image src={Arrow} alt="arrow" width={80} height={80} className="rotate-180" />
											<div className={clsx(
													styles.scrollbar,
								...
								<Image src={extraBorder} alt="extra border" height={500} className={styles.rightBorder} />
							</div>
						</div>
					</>
				),
