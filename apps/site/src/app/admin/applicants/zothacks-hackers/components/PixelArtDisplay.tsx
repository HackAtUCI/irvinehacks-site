...
export default function PixelArtDisplay({ gridColors }: { gridColors: number[] | string }) {
  // Safely parse if string
  ...
  const colorPalette = [
    ...
    "#d50000", "#c51162", "#aa00ff", "#304ffe",
    "#2962ff", "#0091ea", "#00b8d4", "#00c853",
    "#64dd17", "#aeea00", "#ffd600", "#ffab00",
    "#ff6d00", "#dd2c00", "#8d6e63", "#9e9e9e",
  ];
